...
class DisplayuScreen extends StatefulWidget {
  const DisplayuScreen ({super.key});

  @override
  State<DisplayuScreen > createState() => _DisplayuScreenState();
}

class _DisplayuScreenState extends State<DisplayuScreen > {
  @override
  void initState() {
    super.initState();
  }
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text('Hyundai Elantra (used) ',
                  style: TextStyle(
                      fontSize: 30,
